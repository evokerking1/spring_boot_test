...
dependencies {
	...
	implementation("org.springframework.ai:spring-ai-cassandra-store-spring-boot-starter:1.0.0-M2")
...
tasks.generateJava {
	...
	packageName = "dev.evokerking.Evokerking_test_hello.codegen"
	generateClient = true
}
